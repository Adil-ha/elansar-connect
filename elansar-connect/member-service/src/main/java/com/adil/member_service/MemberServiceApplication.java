...
public class MemberServiceApplication {
	...
	CommandLineRunner initDatabase() {
		return args -> {
			...
			member1.setContributionStatus(String.valueOf(ContributionStatus.ACTIVE));
			...
			member2.setContributionStatus(String.valueOf(ContributionStatus.ACTIVE));
			...
			member3.setAddress("789 Maple St");
			member3.setDateOfBirth(LocalDate.of(2000, 12, 31));
			member3.setContributionStatus(String.valueOf(ContributionStatus.INACTIVE));
